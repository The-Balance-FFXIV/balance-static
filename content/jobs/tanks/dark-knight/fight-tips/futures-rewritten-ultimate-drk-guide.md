...
authors:
  ...
  - violet-stardust
patch: "7.4"
lastmod: 2025-12-16T20:06:17.457Z
changelog:
...
We recommend the following opener for Phase One as off-tank. If you're the main tank, this will also work with minor adjustments (in particular, you should of course start with your stance on, and you may wish to pull with **Unmend** for better boss positioning):

![](/img/drk_fru_fatebreakeropener.png "FRU Fatebreaker Opener")

The prepull **TBN** is optional. Fatebreaker queues an auto instantly, so if the MT is not the first to aggro the boss, **TBN** won't break if they parry/block the second auto.

It may help to start the pull at an angle rather than directly south to avoid GCD rollback.
2.46 can **Unmend** pull, but 2.50 will very likely ghost the last **Souleater** with it. You have enough clipping allowance at 2.50 to **Edge** -> **Hard Slash**
...
Last **Edge** is timed to hit the end of buffs while keeping Darkside up through Fall of Faith downtime.

Wait a fraction of a second until the Powder Mark Trail castbar ends to press **Shadowed Vigil**. If the **Shadowed Vigil** weave pushes your last **Edge** out of buffs, you can move it up a GCD just for the excog effect rather than mit + excog.
...
The minimum amount of MP you need to spend is 2 **Edge of Shadow**s after downtime, 1 **TBN** on Burnished/Powder Mark, spend Dark Arts proc, then **TBN** again for second Powder Mark hit. You can also carry **Carve and Spit** and 1 **Shadowbringer** charge into Phase Two.
...
Your pre-Diamond Dust MP management will vary somewhat depending on Phase One killtime. You need to refresh Darkside to 60 seconds after the Quadruple Slap to keep it through the downtime. Passive generation during Diamond Dust is around 2600, and you need to refresh again after returning. With high MP and a Dark Arts proc going in, that means 2 **Edge of Shadow**s at the start, **TBN** during, and **Edge of Shadow** after Quadruple Slap if not invulning, or just Edge of Shadow after if you are, then **TBN** after the Diamond Dust cast starts. 
...
**Reprisal** can cover both the Banish stack/spreads before Light Rampant and the Light Rampant cast itself. **Dark Missionary** can cover the puddle drops plus stacks if used after the boss goes untargetable, but can't be used for Light Rampant if it was used for Diamond Dust. 
...
Hitting **Rampart**/**Shadowed Vigil** to deal with auto-attack damage during the Fulgent Blade 'exalines' helps quite a bit. You can use them on the first set if using cooldowns on the second Wings, or on the third set if using cooldowns on the first Wings. 
