...
bis:
  - type: xivgear
    ...
    link: https://xivgear.app/embed/bis/drk/current?onlySetIndex=0
    description: Speed should be chosen according to comfort, but this set is
      generally recommended.
  - type: xivgear
    name: Current BiS (2.46)
    link: https://xivgear.app/embed/bis/drk/current?onlySetIndex=1
  - type: genericlink
  ...
  - type: genericlink
    ...
    link: https://xivgear.app/bisbrowser/drk/archive
authors:
  - Balance-DRK-Staff
  - apileofcats
  - silaqui-amakiir
