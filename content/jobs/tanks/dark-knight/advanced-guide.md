...
Pulling with **Shadowstride** can add some additional challenges, though. One thing to be aware of if you opt to pull with **Shadowstride** is that if you are the pulling tank, centring the boss so that everyone can attack the boss as soon as possible, and the boss won't jump around near the start, interrupting melee GCD uptime. Your GCD uptime is less important than the combined rest of your party's, so it's important not to grief you party here.
