...
Ultimately, this doesn't matter all *that* much for Dark Knight, since **Salt and Darkness**'s falloff is just 25%, so even if the first target is an invulnerable enemy you only lose 125 potency's worth of damage, but it can still be good to know exactly how this is determined.
