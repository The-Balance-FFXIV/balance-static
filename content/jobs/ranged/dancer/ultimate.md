...
BiS - Relic Weapon (ilvl 535 custom stats)
BiS - Relic Weapon (ilvl 515 custom stats)
BiS - Ultimate Twashtar (TEA weapon)
BiS - Edengrace Weapon
...
Potion Timings
On the Living Liquid opener (optional, but if you notice that using vs. not using the potion is affecting your group’s damage consistency in Living Liquid, consider committing to either using it or not using it during this opener)
...
Start of Perfect Alexander (NOTE: this will only line up with Technical Step / Devilment if your group is using buffs right at the beginning of the phase)
Start of 2nd Exatrine during Perfect Alexander (should line up with final use of Technical Finish / Devilment)
...
Option 2 (forced clip opener, uses a double weave after Technical Finish to buff the first GCD with Devilment while making sure Liquid Hand has spawned before SS goes off):
...
Jagd Doll (Standard Finish Crit + DH)
Jagd Doll (Standard Finish no Crit nor DH)
...
Opener in this Phase (assuming not the speed run strategy):
