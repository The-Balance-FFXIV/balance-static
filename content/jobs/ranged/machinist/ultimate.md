...
Alternatively, if you’re not attempting to unload everything in short buff windows this rotation can be done while still keeping Wildfire before stillness, but the 2nd cast of drill will be slightly delayed. This won’t result in any lost casts. While it loses some potency inside certain buffs it has the added benefit of getting your 1st drill inside the pot: 
...
Phase 4 lasts exactly 6 minutes. This means we’re capable of using Wildfire three times and pots twice. Due to the pot alignment and syncing up with buffs it’s suggested you hold your 3rd Wildfire and 2nd pot for either 4:30 or 5:00 (depending on your party comp). This usage should be discussed with your party.
...
Specific to the 2.46 GCD we spoke of earlier, you may notice that Garuda jumps at an awkward time after the first set of cleanses go off. I handled this by using a 4-Heat Blast Hypercharge into Clean Shot. I ran into the issue where if I wasn’t using Hypercharge before the jump, I would be forced to delay Drill/Hot Shot, or I would overcap heat. Doing this avoided that problem and also ended my combo before the jump so I didn’t need to worry about it dropping with a ton of gauge to spend. Faster GCD speeds can either hold Hypercharge for post-jump or use a full 5 Heat Blasts and still get the clean shot off, at the cost of using a skill speed accessory or dropping more skill speed into their relic at the cost of another substat. 
