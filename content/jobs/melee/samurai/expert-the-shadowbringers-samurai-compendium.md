...
Applying Higanbana with a Yukikaze Sen
In 2 target AOE situations, using a Yukikaze Sen for Tenka as much as possible.
Ensuring we avoid Yukikaze under Meikyo as much as possible.
...
Add a Yaten Enpi to the rotation
Revert a Meikyo Gekko back to Yukikaze (and therefore switch a Yuki Combo in the cooldown phase to a Gekko Combo)
Switch the Yukikaze + Hagakure filler to a Gekko + Hagakure filler
...
Option 1) We don’t immediately use Meikyo/Bana/Tsubame when they become available, and instead use them at the normal point in our rotation. 
...
Option 2) We Meikyo on cooldown but at a different Sen, break our current loop and revert to an ADHOC rotation style for the remainder of the phase or fight.
...
Option 3) Drop your filler GCDs for that cycle.
...
The first required filler GCD
The second required filler GCD
Initiating Higanbana with a Gekko or Meikyo’d Sen
...
Higanbana 1st Opener + 2.14 GCD Looping Rotation
https://youtu.be/7mCoCOIAWqo - [4:35]
...
Viable GCD Tiers for Looping
Viable Skill
Speed Range
60s Loop GCD Count
Required Filler GCDs
2.16 < 2.15 > 2.14
457 to 811
28
2
