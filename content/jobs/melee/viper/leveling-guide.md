...
It is important to note that Uncoiled Fury is a damage loss in single-target until level 92, before it has follow-up oGCDs. Before level 92 players should only use Uncoiled Fury to maintain uptime when necessary, or using it right before a boss dies if the last hit is not otherwise going to be a doubleblade combo finisher.
