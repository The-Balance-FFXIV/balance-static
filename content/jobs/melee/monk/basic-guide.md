...
Effectively, each step of our rotation has a pure potency choice and a utility choice. Pure potency being Bootshine, True Strike, Snap Punch, utility being Dragon Kick, Twin Snakes, and Demolish. The utility choices are things you want to upkeep, but not overcap. Hence you'll apply each of them, and then use the pure potency option until they need reapplying.
...
| ![](https://xivapi.com/i/000000/000828_hr1.png) | **Feint** is an oGCD with a 10s duration and a 90s CD, which lowers the target's physical damage dealt by 10% and magic damage dealt by 5%. This is a very nice tool now, as we're finally able to use it in fights that have no physical damage sources. As a tool for both progression and optimization it's invaluable, and you should discuss with your healers/tanks where it's best used for maximum effect. |
...
![](/img/mnkguide_0000_lunarsolar.png)\

![](/img/mnkguide_0001_lunarsolar_detail.png)\
...
Brotherhood's placement is flexible should it ever need to be moved to account for your party comp, but where it currently is placed is pretty good based on current information.

#### Early Lunar Solar

![](/img/mnkguide_0004_earlylunarsolar.png)\

#### Early Double Solar

![](/img/mnkguide_0005_earlydoublesolar.png)\
...
![](/img/mnkguide_0006_rotations.png)\
...
![](/img/mnkguide_0007_braindeadodd.png)\
...
![](/img/mnkguide_0008_braindeadeven.png)\
...
![](/img/mnkguide_0009_optimaldrifttable.png)\
...
![](/img/mnkguide_0010_optimaldriftvisual.png)\


&nbsp;\

*Even Windows Explained*\
![](/img/mnkguide_0011_optimaldrifteven.png)\
...
![](/img/mnkguide_0013_ghostrank.png)\

&nbsp;\

![](/img/mnkguide_0014_damageapp.png)\

&nbsp;\

These images show the damage application on a number of Monk skills. It's called the "Ghost Ranking" because if you press the button and the boss goes invulnerable in a shorter amount of time than is displayed, the damage will not apply; it will "ghost".
