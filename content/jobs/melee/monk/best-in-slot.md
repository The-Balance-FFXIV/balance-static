...
bis:
  - type: plain-text
    ...
    description: >-
      ...
      * Tome Head and Feet are good, you may want to use them in Week 1 depending on loot allocation.

      * If you get a full gear feed, tome ring can be good purchase as it will be the only crafted piece you still wear otherwise by the last floor.

      * When losing or gaining sks, make sure you reach your desired GCD again (usually 1.94) by remelding sks or food swapping (Caramel Popcorn and Nachos)

      * Try (over)melding sks in the last meld slots such that you save gil and can also easily exchange it needed (see above)
  - type: xivgear
    description: ""
  ...
  - type: xivgear
    description: >-
      ...
      on floor 1, the ornate allows us to buy 2 extra tome pieces instead of a
      body. One of which is not included in the savage bis (delays getting all
      tome pieces for bis by a week), but should be considered for week 1 prog.
  ...
  - type: gsheets
    description: "[Direct Link
      ...
      ER6IOt96ckao/edit?tab=t.0#heading=h.ia2i5tbrrhhc)"
