...
Delivers an attack with a potency of 100 to all nearby enemies. If done as the second part of our AoE combo, it instead delivers an attack with a potency of 130 to all nearby enemies, as well as adds ten seconds to your Huton timer assuming your Huton timer is already going, to a maximum of 60 seconds. Just like Death Blossom, this is an AoE attack that deals damage in a five yalm radius around you. Grants 5 Ninki if used in combo.
...
Reduces weaponskill recast time and auto-attack delay by 15%. Starts with a duration of 60 seconds which can be added on to in increments from Armor Crush and Hakke Mujinsatsu back to the maximum of 60 seconds. This is achieved by any three-mudra combination ending in Ten. So Jin>Chi>Ten or Chi>Jin>Ten. Buff is only applied to yourself.
