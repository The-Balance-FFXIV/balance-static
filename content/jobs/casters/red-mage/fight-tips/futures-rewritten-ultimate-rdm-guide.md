...
![An XIVAnalysis screenshot showing a sample sequence of a single combo burst window setting up to bring stacks of Enchanted Swordplay into phase 2](/img/rdm-fru-2.png "Futures Rewritten p1 2m single combo Example")
...
![An XIVAnalysis screenshot showing a sample sequence of a single combo burst window setting up to bring stacks of Enchanted Swordplay into phase 2, including an Enchanted Reprise optimization](/img/rdm-fru-3.png "Futures Rewritten p1 2m single combo Reprise opti")
...
![An XIVAnalysis screenshot showing a phase 2 reopener sequence with no melee combos](/img/rdm-fru-7.png "Phase 2 reopener, no melee combos")
...
As of 7.4, we no longer have to worry about the timing of our melee combos during this mechanic, as we can use Manafication just before the first melee combo of our burst, giving us two 25y melee combos. This allows us to perform an ideal double combo burst window regardless of when our buff comes off cooldown. However, we still need to consider melee range for our uses of Engagement and Corps-a-Corps. As a general rule of thumb, if your P1 killtime is late enough to do a fifth GCD 1e23 double combo burst, you should spend both charges of these oGCDs before your first mirror bait, to ensure you get both within your party's buffs. However, if your P1 killtime is too fast for this, you should hold your second charges of these oGCDs to be used after the first mirror bait, then adjust towards the second mirror bait after using them.
...
As a fake melee in this position, you may want to ask for a tank mit, since you are somewhat squishy and will be out of range of the healers when the cleaves are hitting.
...
Once you arrive at either the middle tower or your clock spot, prepare a Dualcast, then spend your charges of Corps-a-Corps and Engagement after spending the Dualcast. Because of the 7.4 Manaifcation changes, the melee combo range is no longer a concern during Intermission. This means that regardless of melee or ranged position, you can spend Swiftcast during this phase, perform three Dualcasts, and end the phase with the start of a melee combo, so that you can carry finishers into Intermission. This may result in some mana overcap depending on your P1 killtime, but this shouldn’t matter if you plan to overcap going into P5.

If you prefer, you can spend a full melee combo instead of using Swift in this phase. This is slightly more damage in p2, but slightly less damage in Intermission and in p3.
...
When you come out of being frozen, if you are carrying over your finishers from p2, use your potion immediately and weave Embolden as soon as possible. You want to get all of your oGCDs off cooldown while performing finishers on your crystal, so prioritize Fleche first, followed by Contre Sixte, Engagement, and Corps-a-Corps. You can stand on the tip of a diamond pattern on the ground to align the Resolution cleave instead of having to target a distant crystal; refer to the image at the bottom of this section to see a visual reference of where to stand. Weave Manafication after your finishers, then take advantage of the ranged combo if you're in the ranged position. Make sure you spend a charge of Acceleration during the full combo to avoid overcapping. It should be possible to step away from your dark crystal to cleave two crystals with the second Resolution, after which you can spend your Acceleration GCDs.

If you are not carrying over finishers, you should use Swiftcast instead of preparing a Dualcast, because you want to use a potion as soon as possible. Once your crystal is targetable, spend the Swiftcast on Veraero or Verthunder, then weave either Embolden or Fleche, depending on your party's buff timing, as well as Manafication. Initiate a melee combo, weave whichever of Embolden or Fleche you didn't already use, then weave Contre Sixte after Zwerchhau, and Corps-a-Corps and Engagement after Redoublement. If your P1 killtime was fast, then Embolden will not be off cooldown in time to use it early in the reopener; in this case, you should simply use it off cooldown.

If you are in the ranged position, you can move to your Dark Crystal after Resolution on a half melee combo start, or after Redoublement on a full melee combo start, as just like with Mirror Mirror, we still need to consider our melee oGCDs. Depending on your level of confidence, you can press Sprint after your first finisher, run to the other nearby Light Crystal after your first baited cone appears, standing on top of it when you cast Resolution to cleave both, then run back to your Dark Crystal for the second bait. Regardless of what you do, you should weave Acceleration after the first finisher, as well as weaving Vice of Thorns and Prefulgence at any point while buffs are still active. From here, you can spend both the Acceleration and Grand Impact, then weave Acceleration again if it's available, or Dualcast if it's not. Alternatively, you can do a second melee combo in buffs instead of spending Acceleration and Grand Impact, but you should make sure to use Acceleration towards the end of your first combo to ensure it doesn't overcap.

Example ranged position sequence with full combo start and Resolution cleave (7.1): <https://www.twitch.tv/cyclopsdragon/clip/SpotlessMagnificentHamsterKappaWealth-C3j5AthnoI29RCJB>

If you carried the finishers over from before Intermission, you can opt to start another combo at the end of the Intermission to again carry finishers into the next phase. Keep in mind that you will need to use Swiftcast to align the combo as your last GCDs of the phase. Regardless of your approach, you will need to use seven non-combo GCDs within this phase, and you should also be able to sneak in a second use of Contre Sixte at the end of the phase if you followed the recommended order of oGCD usage.

![Image showing a visual reference of where to align yourself to cleave two light crystals with Resolution while in the melee position](/img/rdm-fru-8.png "Intermission Melee Position Resolution cleave visual reference")
