...
* AoE Mitigation in a 30y radius around you
* AoE regen in an 8y radius around you
...
* Holding CU will refresh the regen buff every server tick three seconds a part from each other
